...
@section('content')
    ...
    <div class="content">
            ...
            <div commersive-basket="" commersive-sync="true" class="x____basket-container">
               <form id="basket" method="POST" action="/payment-method>
                  <div class="x____basket-rows">
                        ...
                        <div class="options pull-right">
                           <div class="options pull-right">
                              ...
                              <div class="option col-sm-3 x____option-quantity">
                                 ...
                                 <input class="x----v3 fancy-textbox" value="1" type="text" commersive-quantity="" mo-id="basket item quantity input" mo-type="control" mo-value="1" mo-subject="1444">
                              ...
                              <div class="option remove col-sm-2">
                                 ...
                                 <a href="#" commersive-remove="" mo-type="control" mo-subject="1444">X</a>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="delivery-totals row">
                        ...
                        <div class="mobile-totals row x----v5">
                           <button mo-id="checkout button (mobile)" mo-type="navigation" type="button" class="btn btn-primary" onclick="$(this).prop('disabled', true); $('input[name=\'method\']').val(''); window.location.assign('/payment-method') ">Tiến hành thanh toán</button>
                  ...
                  <button mo-id="checkout button (desktop)" mo-type="navigation" type="button" class="btn btn-success pull-right x____btn x____btn--lg x____btn--neat x----v3" onclick="$(this).prop('disabled', true); window.location.assign('/payment-method') "><span class="glyphicon glyphicon-chevron-right"></span> Tiến hành thanh toán</button>
